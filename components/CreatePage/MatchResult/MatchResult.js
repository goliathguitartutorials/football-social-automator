 ...
 * PAGE: /
 * FILE: /components/CreatePage/MatchResult/MatchResult.js
 * ==========================================================
 */
'use client';
...
import MatchResultForm, { formatScorersForWebhook } from '../../common/PostCreationForms/MatchResultForm/MatchResultForm';
import { GenerateIcon, EditIcon } from './MatchResultIcons';
...
export default function MatchResult() {
    ...
    const triggerWorkflow = async (action, data) => {
        ...
        const payload = {
            action,
            home_team_badge: data.homeTeamBadge, away_team_badge: data.awayTeamBadge,
            home_team_score: data.homeTeamScore, away_team_score: data.awayTeamScore,
            ...formattedScorers,
            background: data.selectedBackground, caption: data.caption, save_background: data.saveCustomBackground
        };
    ...
    const handleGeneratePreview = (data) => triggerWorkflow('result', data);
    const handleYoloPost = (data) => triggerWorkflow('yoloResult', data);
