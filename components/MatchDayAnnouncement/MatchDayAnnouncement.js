 ...
 * PAGE: /
 * FILE: /components/MatchDayAnnouncement/MatchDayAnnouncement.js
 ==========================================================
 */
'use client';
...
import { UploadIcon, GalleryIcon, GenerateIcon, EditIcon } from './MatchDayAnnouncementIcons';
...
export default function MatchDayAnnouncement() {
    ...
    const handleMatchSelect = (eventId) => {
        setBadgeMessage('');
        if (!eventId) {
            setHomeTeamBadge(''); setAwayTeamBadge(''); setMatchDate(''); setKickOffTime(''); setVenue('');
    ...
    const handleGenerateCaption = async () => {
        ...
        const gameInfo = { homeTeam: getTeamNameFromBadge(homeTeamBadge), awayTeam: getTeamNameFromBadge(awayTeamBadge), matchDate, kickOffTime, venue };
    ...
    const triggerWorkflow = async (action) => {
        ...
        const payload = { action, home_team_badge: homeTeamBadge, away_team_badge: awayTeamBadge, match_date: formattedDate, kick_off_time: kickOffTime, venue, background: selectedBackground, caption, save_background: saveCustomBackground };
        try {
    ...
    const handleGeneratePreview = () => triggerWorkflow('match_day_announcement');
